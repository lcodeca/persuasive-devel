...
from environments.stochasticdeeprl import complexcoopstochasticdeepmarlenv
...
def _main():
    ...
    marl_env = None
    if ARGS.env == 'MARL':
        ray.tune.registry.register_env('marl_env', complexcoopstochasticdeepmarlenv.env_creator)
        marl_env = complexcoopstochasticdeepmarlenv.CoopCSPersuasiveDeepMARLEnv(env_config)
    else:
