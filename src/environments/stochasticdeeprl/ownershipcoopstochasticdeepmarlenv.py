...
class OwnershipCoopCSPersuasiveDeepMARLEnv(CoopCSPersuasiveDeepMARLEnv):
    ...
    def get_observation(self, agent):
        ...
        #  'avail_actions': [1, 1, 1, 1, 1, 1],
        #  'obs': array([3454, 2671, 2190, 1797,  120,    6,    2,    2,  660,   27,    0,    0,    0,    0,    0, 1000,    0,    1,    0])},
        # Dict(action_mask:Box(0.0, 1.0, (6,), float32), avail_actions:Box(0.0, 1.0, (6, 2), float32), obs:Box(-339.13, 4043.48, (19,), float64)))
