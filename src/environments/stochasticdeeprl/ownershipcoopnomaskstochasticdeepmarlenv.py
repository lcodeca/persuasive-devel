...
from environments.stochasticdeeprl.ownershipnomaskstochasticdeepmarlenv import \
...
def env_creator(config):
    ...
    logger.debug('[env_creator] Environment creation: OwnershipCoopNoMaskCSPersuasiveDeepMARLEnv')
    return OwnershipCoopNoMaskCSPersuasiveDeepMARLEnv(config)

####################################################################################################

#@ray.remote(num_cpus=10, num_gpus=1)
class OwnershipCoopNoMaskCSPersuasiveDeepMARLEnv(CoopCSPersuasiveDeepMARLEnv):
