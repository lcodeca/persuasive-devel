...
from environments.stochasticdeeprl import ownershipcoopnomaskstochasticdeepmarlenv
...
def _main():
    ...
    if ARGS.env == 'MARL':
        ray.tune.registry.register_env(
            'marl_env', ownershipcoopnomaskstochasticdeepmarlenv.env_creator)
        marl_env = \
            ownershipcoopnomaskstochasticdeepmarlenv.OwnershipCoopNoMaskCSPersuasiveDeepMARLEnv(
                env_config)
    else:
