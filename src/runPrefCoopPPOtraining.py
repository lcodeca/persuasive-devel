...
from environments.stochasticdeeprl import prefcoopstochasticdeepmarlenv
...
def _main():
    ...
    marl_env = None
    if ARGS.env == 'MARL':
        ray.tune.registry.register_env('marl_env', prefcoopstochasticdeepmarlenv.env_creator)
        marl_env = prefcoopstochasticdeepmarlenv.PrefCoopCSPersuasiveDeepMARLEnv(
            env_config)
    else:
