...
from environments.stochasticdeeprl import ownershipnomaskstochasticdeepmarlenv
...
def _main():
    ...
    if ARGS.env == 'MARL':
        ray.tune.registry.register_env(
            'marl_env', ownershipnomaskstochasticdeepmarlenv.env_creator)
        marl_env = ownershipnomaskstochasticdeepmarlenv.OwnershipNoMaskCSPersuasiveDeepMARLEnv(
            env_config)
    else:
