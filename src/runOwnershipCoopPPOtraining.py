...
def _main():
    ...
    #     'scenario_config': experiment_config['marl_env_config'],
    # }
    policy_conf['model']['custom_model_config']['true_obs_shape'] = marl_env.get_obs_space(agent)['obs']
    policy_conf['model']['custom_model_config']['action_embed_size'] = marl_env.get_action_space_size(agent)
