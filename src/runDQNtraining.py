...
from configs.dqn_conf import persuasive_dqn_conf
...
CURRENT_METRICS = {
    'min_policy_mean_td_error': {
        ...
        'get': lambda res: res['info']['learner']['unique']['mean_td_error'],
        'value': None,
    },
...
def _main():
    ...
    policy_conf = persuasive_dqn_conf(
