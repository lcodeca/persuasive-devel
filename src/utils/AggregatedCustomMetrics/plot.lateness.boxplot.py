...
class Lateness():
    ...
    def generate(self):
        ...
        axs[0].axhline(y=LATENESS_M, color='r', label='Baseline')
        ...
        axs[1].axhline(y=LATENESS_M, color='r', label='Baseline')
        ...
        axs[2].axhline(y=LATENESS_M, color='r', label='Baseline')
        ...
        axs[3].axhline(y=LATENESS_M, color='r', label='Baseline')
