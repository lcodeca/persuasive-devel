...
def _main():
    ...
    Departure(config.input, config.output, config.outliers).generate()
...
class Departure():
    ...
    def generate(self):
        ...
        fig.suptitle('Departure by Initial Distribution')

        labels, current = self._pack_data('All')
        axs[0].axhline(y=9, linestyle=':')
        axs[0].axhline(y=consts.DEPARTURE_H, color='r', label='Baseline')
        ...
        axs[1].axhline(y=consts.DEPARTURE_H, color='r', label='Baseline')
        ...
        axs[2].axhline(y=consts.DEPARTURE_H, color='r', label='Baseline')
        ...
        axs[3].axhline(y=consts.DEPARTURE_H, color='r', label='Baseline')
        ...
        axs[4].axhline(y=consts.DEPARTURE_H, color='r', label='Baseline')
        axs[4].boxplot(current, showfliers=self._outliers, showmeans=True)
        axs[4].set(title='60_6')
    ...
    #     fig.suptitle('Departure by Reward Model')
