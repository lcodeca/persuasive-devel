...
class Departure():
    ...
    def generate(self):
        ...
        axs[0].axhline(y=DEPARTURE_H, color='r', label='Baseline')
        ...
        axs[1].axhline(y=DEPARTURE_H, color='r', label='Baseline')
        ...
        axs[2].axhline(y=DEPARTURE_H, color='r', label='Baseline')
        ...
        axs[3].axhline(y=DEPARTURE_H, color='r', label='Baseline')
