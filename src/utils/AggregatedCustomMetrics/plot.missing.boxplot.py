...
def _main():
    ...
    Missing(config.input, config.output, config.outliers).generate()
...
class Missing():
    ...
    def generate(self):
        ...
        fig.suptitle('Number of Missing Agents by Initial Distribution')
    ...
    #     fig.suptitle('Number of Missing Agents by Reward Model')
