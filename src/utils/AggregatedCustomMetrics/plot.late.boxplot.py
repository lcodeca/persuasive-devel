...
class Late():
    ...
    def generate(self):
        ...
        axs[0].axhline(y=NUM_LATE, color='r', label='Baseline')
        ...
        axs[1].axhline(y=NUM_LATE, color='r', label='Baseline')
        ...
        axs[2].axhline(y=NUM_LATE, color='r', label='Baseline')
        ...
        axs[3].axhline(y=NUM_LATE, color='r', label='Baseline')
