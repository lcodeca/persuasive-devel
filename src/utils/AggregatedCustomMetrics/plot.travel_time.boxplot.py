...
class TravelTime():
    ...
    def generate(self):
        ...
        axs[0].axhline(y=TRAVEL_TIME_M, color='r', label='Baseline')
        ...
        axs[1].axhline(y=TRAVEL_TIME_M, color='r', label='Baseline')
        ...
        axs[2].axhline(y=TRAVEL_TIME_M, color='r', label='Baseline')
        ...
        axs[3].axhline(y=TRAVEL_TIME_M, color='r', label='Baseline')
