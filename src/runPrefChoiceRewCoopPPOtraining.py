...
from environments.stochasticdeeprl import prefchoicerewcoopstochasticdeepmarlenv
...
def _main():
    ...
    if ARGS.env == 'MARL':
        ray.tune.registry.register_env(
            'marl_env', prefchoicerewcoopstochasticdeepmarlenv.env_creator)
        marl_env = \
            prefchoicerewcoopstochasticdeepmarlenv.PrefChoiceRefCoopCSPersuasiveDeepMARLEnv(
            env_config)
    else:
