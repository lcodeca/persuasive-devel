...
from learning.ownershipactionmaskingmodel import OwnershipActionMaskingModel
...
def persuasive_ppo_conf(rollout_size=10,
    ...
    ModelCatalog.register_custom_model('custom_model', OwnershipActionMaskingModel)
    ...
    custom_configuration['num_cpus_for_driver'] = 2
    custom_configuration['num_cpus_per_worker'] = 2
