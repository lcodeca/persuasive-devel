...
from environments.stochasticdeeprl import complexparkingstochasticdeepmarlenv
...
def _main():
    ...
    marl_env = None
    if ARGS.env == 'MARL':
        ray.tune.registry.register_env('marl_env', complexparkingstochasticdeepmarlenv.env_creator)
        marl_env = complexparkingstochasticdeepmarlenv.CSParkingPersuasiveDeepMARLEnv(env_config)
    else:
