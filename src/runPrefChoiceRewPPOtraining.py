...
from environments.stochasticdeeprl import prefchoicerewstochasticdeepmarlenv
...
def _main():
    ...
    if ARGS.env == 'MARL':
        ray.tune.registry.register_env(
            'marl_env', prefchoicerewstochasticdeepmarlenv.env_creator)
        marl_env = \
            prefchoicerewstochasticdeepmarlenv.PrefChoiceRefCSPersuasiveDeepMARLEnv(
            env_config)
    else:
