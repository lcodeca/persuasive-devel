...
from environments.stochasticdeeprl import complexcoopparkingstochasticdeepmarlenv
...
def _main():
    ...
    if ARGS.env == 'MARL':
        ray.tune.registry.register_env(
            'marl_env', complexcoopparkingstochasticdeepmarlenv.env_creator)
        marl_env = complexcoopparkingstochasticdeepmarlenv.CoopCSParkingPersuasiveDeepMARLEnv(
            env_config)
    else:
