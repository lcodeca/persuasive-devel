...
from environments.stochasticdeeprl import complexstochasticdeepmarlenv
...
def _main():
    ...
    marl_env = None
    if ARGS.env == 'MARL':
        ray.tune.registry.register_env('marl_env', complexstochasticdeepmarlenv.env_creator)
        marl_env = complexstochasticdeepmarlenv.ComplexStochasticPersuasiveDeepMARLEnv(env_config)
    else:
